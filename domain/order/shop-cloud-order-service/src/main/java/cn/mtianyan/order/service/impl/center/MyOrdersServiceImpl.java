...
import cn.mtianyan.order.mapper.OrdersMapperCustom;
import cn.mtianyan.order.pojo.OrderStatus;
import cn.mtianyan.order.pojo.Orders;
import cn.mtianyan.order.pojo.vo.MyOrdersVO;
...
//    }
    ...
    @Override
    public MJSONResult checkUserOrder(@RequestParam("userId") String userId,
                                          @RequestParam("orderId") String orderId) {
        Orders order = queryMyOrder(userId, orderId);
        if (order == null) {
            return MJSONResult.errorMap("订单不存在！！！");
        }
