package cn.mtianyan.cart.controller;

import cn.mtianyan.cart.service.CartService;
...
public class ShopcatController extends BaseController {
    ...
    public MJSONResult del(
        ...
        if (StringUtils.isBlank(userId) || StringUtils.isBlank(itemSpecId)) {
            return MJSONResult.errorMsg("参数不能为空");
        }
